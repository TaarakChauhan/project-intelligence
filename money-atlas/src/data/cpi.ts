/** U.S. CPI-U annual averages, 1982–84 = 100.
 *  Rounded to one decimal from the BLS series (Minneapolis Fed historical table).
 *  2025 annual average is 321.9 (BLS 321.943). 2026 is omitted: the calendar year is not complete.
 */
...
export function inflate(amount: number, fromYear: number, toYear: number): number | null {
